...
const AVAILABLE_SKINS = [
  ...
  { id: 'david',           name: 'David',           path: '/public/skins/Screenshot%202026-03-27%20125840.png', price: 3 },
  { id: 'urban',           name: 'Urban',           path: '/public/skins/Screenshot%202026-03-27%20130240.png', price: 5 },
  { id: 'street_kid',      name: 'Street Kid',      path: '/public/skins/Screenshot%202026-03-27%20130323.png', price: 6 },
  { id: 'charm_casual',    name: 'Casual Charm',    path: '/public/skins/Screenshot%202026-03-27%20131027.png', price: 7 },
  { id: 'pirate',          name: 'Pirate',          path: '/public/skins/Schermafbeelding%202026-03-11%20163611.png', price: 7 },
  { id: 'sunshine',        name: 'Sunshine',        path: '/public/skins/Screenshot%202026-03-27%20130136.png', price: 8 },
  { id: 'cool_vibes',      name: 'Cool Vibes',      path: '/public/skins/Screenshot%202026-03-27%20125948.png', price: 9 },
  { id: 'casual_dude',     name: 'Casual Dude',     path: '/public/skins/Screenshot%202026-03-27%20125840.png', price: 10 },
  { id: 'retro',           name: 'Retro Style',     path: '/public/skins/Screenshot%202026-03-27%20130220.png', price: 11 },
  { id: 'silver_fox',      name: 'Silver Fox',      path: '/public/skins/Screenshot%202026-03-27%20125914.png', price: 12 },
  { id: 'trendy',          name: 'Trendy',          path: '/public/skins/Screenshot%202026-03-27%20130950.png', price: 13 },
  { id: 'adventure',       name: 'Adventure',       path: '/public/skins/Screenshot%202026-03-27%20130256.png', price: 15 },
  { id: 'thunder',         name: 'Thunder Eyes',    path: '/public/skins/Schermafbeelding%202026-03-27%20010011.png', price: 16 },
  { id: 'tech_coder',      name: 'Tech Coder',      path: '/public/skins/Screenshot%202026-03-27%20131012.png', price: 18 },
  { id: 'radahn',          name: 'Radahn',          path: '/public/skins/radahn-miquella-hd-transparent-min.png', price: 21 },
  { id: 'captain',         name: 'Captain',         path: '/public/skins/Screenshot%202026-03-27%20130231.png', price: 25 },
  { id: 'statesman',       name: 'Statesman',       path: '/public/skins/Screenshot%202026-03-27%20130313.png', price: 30 },
  { id: 'elf_lord',        name: 'Elf Lord',        path: '/public/skins/ab67616d00001e02623b2d23babc64bea5b23c30.jpg', price: 34 },
  { id: 'businessman',     name: 'Businessman',     path: '/public/skins/Screenshot%202026-03-27%20130944.png', price: 35 },
